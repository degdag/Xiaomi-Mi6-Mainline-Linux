...
static int jdi_fhd_r63452_on(struct jdi_fhd_r63452 *ctx)
{
	...
	dsi_generic_write_seq(dsi, 0xec, 0x64, 0xdc, 0xec, 0x3b, 0x52, 0x00, 0x0b, 0x0b, 0x13, 0x15, 0x68, 0x0b, 0xb5);
...
static int jdi_fhd_r63452_off(struct jdi_fhd_r63452 *ctx)
{
	...
	dsi_generic_write_seq(dsi, 0xb0, 0x00);
	dsi_generic_write_seq(dsi, 0xd6, 0x01);
	dsi_generic_write_seq(dsi, 0xec, 0x64, 0xdc, 0xec, 0x3b, 0x52, 0x00, 0x0b, 0x0b, 0x13, 0x15, 0x68, 0x0b, 0x95);
	dsi_generic_write_seq(dsi, 0xb0, 0x03);
...
static const struct of_device_id jdi_fhd_r63452_of_match[] = {
	{ .compatible = "jdi,fhd-r63452" }, // FIXME
	{ /* sentinel */ }
};
...
MODULE_DESCRIPTION("DRM driver for JDI FHD R63452 command mode panel");
